...
function RegisterComponent() {
  ...
  const [isPasswordTyped, setIsPasswordTyped] = useState(false); // State to track if password input has been typed
  const [acceptedTerms, setAcceptedTerms] = useState(false); // State to track if terms are accepted
  ...
  const handlePasswordChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!isPasswordTyped) {
      setIsPasswordTyped(true); // Set to true when user starts typing
    }
  };
                ...
                <>
                  ...
                  <form className="mt-6" onSubmit={handleSubmit} method="POST">
                    <div className="flex flex-col gap-4">
                      ...
                      {isPasswordTyped && ( // Conditionally render the PasswordValidation component
                    ...
                    <div className="mt-6">
                      <Button
                        ...
                        className="w-full"
                        loading={loading}
                        disabled={loading || !isPasswordValid || !acceptedTerms} // Disable if loading, password is invalid, or terms are not accepted
                      >
                        {t("Sign up")}
                      </Button>
                    </div>
