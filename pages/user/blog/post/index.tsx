  ...
  const handleFileUpload = async (files: File[]) => {
    if (files.length > 0) {
      ...
      if (result.success) {
        ...
        setPostData((prev) => (prev ? { ...prev, image: result.url } : null));
      } else {
          ...
          <div className="flex gap-2">
            ...
            <ListBox
              ...
              setSelected={(selectedCategory) =>
                setPostData((prev) =>
                  prev ? { ...prev, categoryId: selectedCategory.value } : null
                )
              }
            />
            <ListBox
              ...
              setSelected={(e) =>
                setPostData((prev) => (prev ? { ...prev, status: e } : null))
              }
            />
          </div>
          <div className="my-5">
            <InputFile
              ...
              onRemoveFile={() => {
                setImageUrl(null);
                setPostData((prev) => (prev ? { ...prev, image: "" } : null));
              }}
            />
          </div>
